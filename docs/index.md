...
- **account_id** (String) Your Satori account ID.

### Optional

- **service_account_id** (String) Service account ID with administrative privileges. Can be specified with the `SATORI_SA_ID` environment variable.
